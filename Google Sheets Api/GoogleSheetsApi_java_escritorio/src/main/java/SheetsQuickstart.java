...
//        // Load client secrets.
//        InputStream inOriginal = SheetsQuickstart.class.getClass().getResourceAsStream("/initialization" + CREDENTIALS_FILE_PATH);
//
//
...
//        }
//        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(inOriginal));
//
//
...
//        return new AuthorizationCodeInstalledApp(flow, receiver).authorize("user");
    ...
    public static Sheets getGoogleSheetService() {
