...
import martin.botoneraforgottera.Sticker.AddStickerPackActivity;
import martin.botoneraforgottera.Sticker.BaseActivity;
...
public class BaseFragmentStickers extends Fragment {

	private static final int ADD_PACK = 200;
	private static final String TAG = "AddStickerPackActivity";

	public BaseFragmentStickers() {
	}
