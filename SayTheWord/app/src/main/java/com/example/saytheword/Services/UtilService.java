...
public class UtilService {
	...
	// public List<Palabra> palabrasUsadas = new ArrayList<Palabra>();
	...
	public List<Palabra> getPalabras() {
		return new ArrayList<Palabra>() {{
			...
			add(new Palabra("111", "Gritando", ""));

			add(new Palabra("222", "Amplio", ""));

			add(new Palabra("444", "Silbar", ""));

			add(new Palabra("555", "Silbar", ""));

			add(new Palabra("666", "Silbar", ""));
