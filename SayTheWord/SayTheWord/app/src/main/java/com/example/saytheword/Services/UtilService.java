	...
	public List<Palabra> getPalabras(boolean soloPalabrasProblematicas) {
		...
		if (palabras.isEmpty()) {
			palabras = new ArrayList<Palabra>() {{
				...
				add(new Palabra("Advice", "Consejo", "Edvice"));
				...
				add(new Palabra("Haunted", "Obsesionado", "Haunted"));
				...
				add(new Palabra("Encourage", "Alentar, fomentar", "Incoreich"));
				add(new Palabra("Sludge", "Lodo", "Slodg"));
				add(new Palabra("Slither", "Deslizarse", "Slither"));
				add(new Palabra("Charms", "Encantos", "Charms"));
