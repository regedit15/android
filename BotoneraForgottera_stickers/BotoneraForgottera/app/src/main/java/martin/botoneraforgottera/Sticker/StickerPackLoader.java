...
import static martin.botoneraforgottera.Sticker.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.AVOID_CACHE;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.IMAGE_DATA_VERSION;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.PUBLISHER_EMAIL;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.PUBLISHER_WEBSITE;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static martin.botoneraforgottera.Sticker.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
